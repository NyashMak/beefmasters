...
@section('body')
      ...
      <div class="block block-rounded">
        <div class="block-header block-header-default">
          <h3 class="block-title">Discount Info</h3>
        </div>
      </div>
                ...
                <div class="col-md-10 col-lg-8">
                  <form action="{{route('discounts.store')}}" method="POST">
                    ...
                    <div class="mb-4">
                      ...
                      <label class="form-label" for="shop_id">Percentage/ %</label>
                      <input type="number" class="form-control" name="discount_percent" value="">
                    </div>
                    <div class="mb-4">
