...
@section('body')
          ...
          <div class="row items-push">
            <div class="col-6 col-lg-3">
              <a class="block block-rounded block-link-shadow text-center h-100 mb-0" href="{{route('discounts.create')}}">
          ...
          <div class="block block-rounded">
            <div class="block-header block-header-default">
              <h3 class="block-title">All Discounts</h3>
                      ...
                      <tr>
                        <td class="text-center fs-sm">
                          <a class="fw-semibold" href="be_pages_ecom_product_edit.html">
                            <strong>CID.{{$discount->id}}</strong>
                          </a>
                        </td>
                        <td class="d-none d-sm-table-cell text-center fs-sm">{{$discount->created_at}}</td>
                        <td class="d-none d-md-table-cell fs-sm">
                          <a class="fw-semibold" href="be_pages_ecom_product_edit.html">{{$discount->name}}</a>
                        </td>
                        ...
                        <td class="text-center fs-sm">
                          <a class="btn btn-sm btn-alt-secondary" href="{{route('discounts.edit',$discount->id)}}">
