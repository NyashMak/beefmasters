					...
					<div class="post-item">
						...
						<ul class="lab-ul footer-location">
							...
							<li>
								...
								<div class="content-part">
									<p>25/2 Lane2 Vokte Street Building <br>Cape Town</p>
								</div>
							</li>
						</ul>
					</div>
	...
	<div class="footer-bottom  bg-ash">
		<div class="container">
			<div class="section-wrapper">
				<p class="text-center">&copy; 2022 <a href="index.html">Beef Masters</a>.All Rights Reserved By <a href="#">Wellprune</a></p>
			</div>
		</div>
	</div>
</footer>
