        ...
        <section class="main-header" style="background-image:url(assets/butcher/images/gallery-2.jpg)">
            <header>
                <div class="container text-center">
                    <h2 class="h2 title">Checkout : Payment</h2>
            ...
            <div class="container">
                ...
                <div class="clearfix">
                    <div class="row">
                        ...
                        <div class="col-xs-6 text-right">
                            <a href="checkout-4.html" class="btn lab-btn"><span class="icon icon-cart"></span> Checkout</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="clearfix">
                    <div class="row">
                        ...
                        <div class="col-xs-6 text-right">
                            <a href="{{route('receipt')}}" class="btn lab-btn"><span class="icon icon-cart"></span> Checkout</a>
                        </div>
                    </div>
                </div>
