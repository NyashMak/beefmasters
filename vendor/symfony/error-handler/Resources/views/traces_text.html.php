        ...
        <tr>
            <th class="sf-toggle" data-toggle-selector="#trace-text-<?= $index; ?>" data-toggle-initial="<?= 1 === $index ? 'display' : ''; ?>">
                <div class="trace-class">
                    ...
                    <span class="icon icon-close"><?= $this->include('assets/butcher/images/icon-minus-square-o.svg'); ?></span>
                    <span class="icon icon-open"><?= $this->include('assets/butcher/images/icon-plus-square-o.svg'); ?></span>
                </div>
            </th>
        </tr>
    </thead>
